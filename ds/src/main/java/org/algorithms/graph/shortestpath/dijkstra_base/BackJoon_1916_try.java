package org.algorithms.graph.shortestpath.dijkstra_base;
...
//최소비용 구하기
public class BackJoon_1916_try {
    ...
    static void dijkstra(int start) {
        ...
        // 최소 힙 생성
        //: 거리 배열을 비교하는 데에는 숫자하나만을 사용하므로, 숫자하나를 비교하는 메서드
        ...
        while (!pq.isEmpty()) {
            ...
            for (Edge e : edges[info.idx]) {
                ...
                pq.offer(new Info(e.to, e.weight));
            }
        }
    }
